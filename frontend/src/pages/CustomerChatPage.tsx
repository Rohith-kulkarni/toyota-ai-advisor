...
import { createLeadFromChat, sendChatMessage } from "../api/client";
  ...
  async function sendMessage(messageText: string) {
    ...
    try {
      const data = await sendChatMessage(
        sessionId ? { sessionId, message: trimmedMessage } : { message: trimmedMessage }
      );
          ...
          <div className="chat-messages">
            {messages.length === 0 ? (
              <div className="empty-state">
                ...
                <p>
                  Tell us what you need and we&apos;ll suggest Toyota models using the local
                  knowledge base.
                </p>
              </div>
            ) : null}
